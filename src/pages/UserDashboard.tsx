...
const UserDashboard = () => {
  ...
  const medicinesViewed = searchHistory.filter(h => h.medicineId).length;
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="bg-card rounded-2xl border border-border p-6 sm:p-8 shadow-card mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold font-display text-foreground">Welcome back, {user.name}</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold font-display text-foreground">
                      <AnimatedCounter value={searchHistory.length} />
                    </p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold font-display text-foreground">
                      <AnimatedCounter value={medicinesViewed} />
                    </p>
            ...
            >
              <div className="p-6 border-b border-border flex items-center justify-between">
                ...
                {searchHistory.length > 0 && (
                  <Button variant="ghost" size="sm" onClick={clearSearchHistory} className="text-destructive hover:text-destructive hover:bg-destructive/10 rounded-lg">
